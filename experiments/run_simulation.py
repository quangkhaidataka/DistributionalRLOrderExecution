...
DEFAULT_SIM_CONFIG = dict(
    ...
    ou_theta= 0.15,
    ou_mu   = 100.0,
    # Symmetric zero-mean jump-diffusion stress scenario. μ_J=0 removes the
    # drift confound; (λ_J, σ_J) LOCKED by scan_jump_calibration.py (2026-07-17)
    # to (0.05, 0.16). Pre-declared fallback: (0.05, 0.12). See DECISION.md.
    jump_intensity = 0.05,
    jump_mean      = 0.0,
    jump_std       = 0.16)
